...
openai_api_key = os.getenv("OPENAI_API_KEY", "sk-gtFMy0hn65xoci1PySmQga9DPjksFCcPluwTdiM7fmqaToXV")
openai_api_base = os.getenv("OPENAI_API_BASE", "https://zapi.aicc0.com/v1")
model_name = os.getenv("MODEL_NAME", "gpt-5.4")
embedding_model_name = os.getenv("EMBEDDING_MODEL_NAME", "text-embedding-3")
